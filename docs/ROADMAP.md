...
- **Bingo PostgreSQL Integration**
  ...
  - ✅ **Data types** (`BingoMol`, `BingoBinaryMol`, `BingoReaction`, `BingoBinaryReaction`)
  - ✅ **Functions** : all function autogenerated from extracted metadata
  - ✅ **Migration**: Alembic support for schema changes
  - ⬜ **Full functions annotations and type hints**


- **RDKit PostgreSQL Integration**
  - ✅ **Core data types** (`RdkitMol`, fingerprint types)
  - ✅ **Chemical indices** (`RDKitMolIndex`, etc.)
  - ✅ **Functions**: most common functions autogenerated from extracted metadata
  - ✅ **Migration**: Alembic support for schema changes
  - ⬜ **Full functions annotations and type hints**


- **Tutorials and Examples**
  - ✅ Basic usage examples for Bingo and RDKit
